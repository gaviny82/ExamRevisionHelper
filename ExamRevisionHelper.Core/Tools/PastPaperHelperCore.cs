...
namespace ExamRevisionHelper.Core
{
    ...
    public sealed class PastPaperHelperCore
    {
        ...
        public DirectoryInfo LocalFileStorage { get; set; }
        public PaperSource CurrentSource { get; private set; }
        ...
        public Dictionary<Subject, PaperRepository> SubscriptionRepo { get; } = new Dictionary<Subject, PaperRepository>();
        ...
        public PastPaperHelperCore([NotNull] XmlDocument userData, [NotNull] DirectoryInfo localFileStorage, [NotNull] UpdateFrequency updatePolicy, [NotNull] IEnumerable<string> subscription)
        {
            ...
            try
            {
                ...
                CurrentSource.LoadUserData(userData);
            }
            catch (Exception e)
            {
