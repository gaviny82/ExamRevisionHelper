...
namespace ExamRevisionHelper.Sources
{
    ...
    {
        public const string DEFAULT_OPTION = "gce_guide";
        ...
        public async virtual Task AddOrUpdateSubject(Subject subj)
        {
            ...
            var repo = await GetPapersAsync(subj).ConfigureAwait(false);
        ...
        public abstract Task<PaperRepository> GetPapersAsync(Subject subject);
